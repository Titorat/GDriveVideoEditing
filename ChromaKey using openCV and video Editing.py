...
Original file is located at
    https://colab.research.google.com/drive/1dJ3lwcRWYriOt3E4o0eiVDdwjvh2bjdq
"""
...
def mergeAudioFiles(video_name,audio):
  ...
  for i in os.listdir(nameOfAudioFolder):
    ...
    # print(i)
    # print(ms)
    audioFilesList.append((audio_temp,ms))
  return (CompositeAudioClipReplace(audioFilesList))

# video = VideoFileClip("drive/My Drive/Video Bot/Video/upworksample1.mov")
# audio = video.audio
# audio.write_audiofile("drive/My Drive/Video Bot/Test/upworkTestAudio.mp3")
